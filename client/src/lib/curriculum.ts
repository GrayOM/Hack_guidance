...
const levelContent = [
  {
    ...
    label: "웹 관찰 기초",
    description: "브라우저 안에 이미 존재하는 신호를 읽는 법을 익힙니다.",
...
const plannedTitles = [
  ["페이지 주석 찾기", "숨은 입력값 확인", "주소의 상태값", "쿠키의 역할", "응답 헤더 읽기", "폼 데이터 비교", "리디렉션 추적", "캐시의 흔적", "robots.txt 관찰", "Level 1 평가"],
  ["GET 요청 분석", "POST 요청 분석", "인증 상태 구분", "세션 수명 확인", "권한 없는 화면", "다운로드 응답", "파일명 검증", "입력 형식 확인", "오류 응답 읽기", "Level 2 평가"],
  ["출력 문맥 이해", "안전한 인코딩", "검색 요청 구조", "질의의 조건식", "파일 경로 처리", "업로드 검증", "오류 정보 노출", "브라우저 저장소", "입력 흐름 검토", "Level 3 평가"],
  ["리소스 식별자", "사용자별 데이터", "권한 검증 흐름", "세션 재확인", "토큰 구조 읽기", "API 응답 필드", "요청 빈도 제한", "감사 로그", "접근 정책 검토", "Level 4 평가"],
  ["정보 수집 정리", "단서 우선순위", "인증 흐름 검토", "입력·출력 연결", "파일 처리 검토", "API 경계 분석", "권한 검증 보고", "방어책 비교", "최종 분석 준비", "Level 5 평가"],
];
